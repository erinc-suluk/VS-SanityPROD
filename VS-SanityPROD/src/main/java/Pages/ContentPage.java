...
public class ContentPage extends HelperFunctions{
	...
	@FindBy(xpath="//h1[normalize-space()='Often-asked questions']")
	private WebElement accordionTitle;
	
	@FindBy(xpath="(//button[@class='cmp-accordion__button cmp-accordion__button--expanded'])[2]")
	private WebElement accordion1button;
	...
	private static List<WebElement> helpfulLinks;
...
ReadXLSdata read1=new ReadXLSdata();
	...
	public void setAccordion(ExtentTest test) throws Exception {
	    ...
	    HelperFunctions.staticWait(3);
	   HelperFunctions.scrollToElement(accordionTitle);
	   Assert.assertTrue(accordion1.isDisplayed());
	   HelperFunctions.staticWait(2);
	   Assert.assertTrue(!accordion2.isDisplayed());
	   HelperFunctions.staticWait(2);
	   accordion2button.click();
	   HelperFunctions.staticWait(2);
	   Assert.assertTrue(!accordion1.isDisplayed());
	   HelperFunctions.staticWait(2);
	   Assert.assertTrue(accordion2.isDisplayed());
